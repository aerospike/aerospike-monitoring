...
def test_panels_count():
    baseline_dict_queries = read_dashboard_queries(fn_baseline_queries)
    mock_dict_queries = read_dashboard_queries(fn_mock_queries)

    SET_FROM_BASELINE = loop_for_count(baseline_dict_queries, ["folder","dashboard_file","dashboard_name","row_id","row_title","panel_id","panel_name"])
    SET_FROM_MOCK = loop_for_count(mock_dict_queries, ["folder","dashboard_file","dashboard_name","row_id","row_title","panel_id","panel_name"]) 
...
def test_panel_names():
    ...
    SET_FROM_BASELINE = loop_for_names(baseline_dict_queries,["folder","dashboard_file","dashboard_name","row_id","row_title","panel_id"],"panel_name")
    SET_FROM_MOCK = loop_for_names(mock_dict_queries,["folder","dashboard_file","dashboard_name","row_id","row_title","panel_id"],"panel_name")
